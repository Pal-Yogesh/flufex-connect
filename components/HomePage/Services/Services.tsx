...
import { MdPeople, MdTrendingUp, MdSecurity, MdVideoLibrary } from "react-icons/md";
                ...
                <div className="relative w-[500px] h-[500px] -ml-40 flex justify-center items-center">
                  ...
                  {serviceData.map((step, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`bg-[#2A2A2A] rounded-full border-2 transition-all duration-300 flex items-center justify-center ${
                            activeStep === index
                        ...
                        >
                          {(() => {
                            ...
                            return <IconComponent className="w-[55px] h-[55px] text-[#FF6E1F] p-3" />;
                          })()}
                        </div>
                      </motion.div>
                    );
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-start gap-4 mb-6">
                        <motion.div
                          ...
                          className="p-3 rounded-xl bg-[#FF6E1F]/20 flex items-center justify-center"
                        >
                          {(() => {
                            const IconComponent = serviceData[activeStep].icon;
                            return <IconComponent className="w-10 h-10 text-[#FF6E1F]" />;
                          })()}
                        </motion.div>
          ...
          {serviceData.map((service, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="rounded-full p-2 bg-[#FF6E1F]/20 flex items-center justify-center">
                  {(() => {
